...
## Step 2a - Create Python virtual environment and activate
```
python3 -m venv venv
source venv/bin/activate
```

## Step 2b - Upgrade Pip and install Pytest
```
...
======================================================================================= test session starts =======================================================================================
platform linux -- Python 3.7.16, pytest-7.3.1, pluggy-1.0.0 -- /week1-devops/venv/bin/python3
cachedir: .pytest_cache
rootdir: /home/ec2-user/environment/week1-devops
collected 4 items                                                                                                                                                                                 
